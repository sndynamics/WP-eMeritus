...
$web_utmterm	 = 'diploma';
	...
	set_query_var( 'courseType', 'diploma');
	...
	<div class="row">
		<div class="small-12 <?php if ( 'on' === $sidebar ) { ?>medium-8<?php } ?> small-order-1 columns">
			<header class="post-title page-title">
				<h1 class="entry-title" itemprop="name headline">Online Post Graduate Diploma Programs</h1>
			</header>
			<div class="post-content no-vc">
				Choose from a world-class selection of online diploma courses to access the highest standards of learning and development opportunities taught by globally renowned faculty. Accelerate your career with a collaborative and stimulating online program.
			</div>
		</div>
	</div>
</div>
